...
var defaultColumns = [1, 5, 4, 10, 21, 3, 29]; //Alias,Remit to,Supplier Name,Supplier Number,Legal Entity,Tax ID,Actions
...
function initializeDataTable() {
    table = $('#dataTable').DataTable({
        ...
        columnDefs: [
            ...
            {
                targets: 29, //Add View, edit and delete buttons to last column of table
