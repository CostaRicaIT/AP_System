...
function DrawTable() {
    ...
    table = $('#wsdataTable').DataTable({
        ...
        columns: [
            ...
            { data: 'Dates', name: 'WS_TEMP_BILLING_PRERIOD_DATE', className: "scrollable-content" },
            ...
            { data: 'OrganizationType', name: 'WS_TB_ORACLE_TYPE.ORACLE_TYPE_NAME', className: "scrollable-content" },
            { data: 'TaxPayerID', name: 'ETEMP_TAXPAYER_ID', className: "scrollable-content" },
