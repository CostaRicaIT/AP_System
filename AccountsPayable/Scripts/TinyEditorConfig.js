...
tinymce.init({
    selector: 'input.TinyEditorSmall, textarea.TinyEditorSmall', //select field using input.class
    promotion: false, //Hide upgrade promotion of TinyMCE
    branding: false, //Hide TinyMCE logo
    statusbar: false,
    menubar: false,
...
tinymce.init({
    selector: 'input.TinyEditorSmallReadOnly, textarea.TinyEditorSmallReadOnly', //select field using input.class
    promotion: false, //Hide upgrade promotion of TinyMCE
    branding: false, //Hide TinyMCE logo
    readonly: true,
    statusbar: false,
