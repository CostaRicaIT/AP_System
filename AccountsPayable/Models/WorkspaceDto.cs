...
namespace AccountsPayable.Models
{
    ...
    {
        public int WS_Id { get; set; }                  //WS ID
        public string Ws_duedate { get; set; }        //WS Due Date
        public string Ws_status { get; set; }              //WS Status
        public string Ws_reason { get; set; }              //WS Reason
        public string Ws_email_received { get; set; }      //WS Email
        public string Ws_created_date { get; set; }        //WS Created date
        public string Ws_source { get; set; }              //WS Source
        public string Ws_handled_by { get; set; }          //WS handled by
        public string Ws_invoice_date { get; set; }        //WS invoice date
        public string Ws_amount { get; set; }              //WS amount
        public string Ws_invoice_number { get; set; }      //WS invoice number
        public string Ws_comments { get; set; }            //WS comments
        public string Ws_last_actions { get; set; }        //WS last actions
